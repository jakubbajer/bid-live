defmodule BidliveWeb.UserAuth do
  use BidliveWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  alias Bidlive.Accounts
  alias Bidlive.Accounts.Scope

  # Make the remember me cookie valid for 14 days. This should match
  # the session validity setting in UserToken.
  @max_cookie_age_in_days 14
  @remember_me_cookie "_bidlive_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  @doc """
  An on_mount hook for LiveViews that assigns the current scope.
  """
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      BidliveWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
