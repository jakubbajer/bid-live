defmodule BidliveWeb.UserAuthTest do
  use BidliveWeb.ConnCase

  alias Bidlive.Accounts
  alias Bidlive.Accounts.Scope
  alias BidliveWeb.UserAuth

  import Bidlive.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BidliveWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
